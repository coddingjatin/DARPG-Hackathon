...
def click_lbl(event):
    w=Toplevel()
    p=PhotoImage(file='imag/flowChart.png')
    la=Label(w,image=p)
    la.pack()
    w.mainloop()
def forward():
...
def registration_pics():
    ...
    rwin=Toplevel()
    f=Frame(rwin)
    rpic1=PhotoImage(file='imag/fi.PNG')
    rpic2=PhotoImage(file='imag/secq.png')
    rpic2_1=PhotoImage(file='imag/secq2.png')
    rpic3=PhotoImage(file='imag/thir.png')
    rpic4=PhotoImage(file='imag/fr.png')
    rpic5=PhotoImage(file='imag/fiv.png')
    rpic6=PhotoImage(file='imag/si.png')
...
def lodging_pics():
    ...
    rwin=Toplevel()
    f=Frame(rwin)
    rpic1=PhotoImage(file='imag/a.png')
    rpic2=PhotoImage(file='images/b.png')
    rpic2_1=PhotoImage(file='imag/b2.png')
    rpic3=PhotoImage(file='imag/c.png')
    rpic4=PhotoImage(file='imag/d.png')
    rpic5=PhotoImage(file='imag/e.png')
...
def user_Q(x):
    ...
    if d_query in ['how can i call you']:
        query="Actually i don't have any name so , you can call me anything "
    ...
    if ind==8:
       ...
       if ind==6:
            ...
            i=0
                ...
                picf=PhotoImage(file='imag/flowchartt.png')
...
def chatbot():
    ...
    pun=open('data/puntuations.txt',encoding='UTF-8').read().split()
    fil=open('data/query_filters.txt',encoding='UTF-8').read().split()
    words=open('data/Overall words.txt').read().split('\n')
    window=Tk()
    f1=Frame(window)
    w=(m[0].width)-456
    h=(m[0].height)-(88+620)
    ...
    pic1=PhotoImage(file='chatb/main.png')
    l=Label(window,image=pic1,bg='lightgray')
    l.pack()
    pic=PhotoImage(file='chatb/bot.png')
    window.iconbitmap('chatb/icon.ico')
    ...
    voiceicon=PhotoImage(file='chatb/microphone.png')
    sendicon=PhotoImage(file='chatb/send.png')
...
#main logic     
def mainicon():
    pic=image.load_animation('chatb/icon.gif')

...
def registration_pics():
    ...
    rwin=Toplevel()
    f=Frame(rwin)
    rpic1=PhotoImage(file='imag/1.PNG')
    rpic2=PhotoImage(file='imag/2.png')
    rpic2_1=PhotoImage(file='imag/2_1.png')
    rpic3=PhotoImage(file='imag/3.png')
    rpic4=PhotoImage(file='imag/4.png')
    rpic5=PhotoImage(file='imag/5.png')
    rpic6=PhotoImage(file='imag/6.png')
...
def lodging_pics():
    ...
    rwin=Toplevel()
    f=Frame(rwin)
    rpic1=PhotoImage(file='imag/pg_1.png')
    rpic2=PhotoImage(file='images/pg_2.png')
    rpic2_1=PhotoImage(file='imag/pg_2_1.png')
    rpic3=PhotoImage(file='imag/pg_3.png')
    rpic4=PhotoImage(file='imag/pg_4.png')
    rpic5=PhotoImage(file='imag/pg_5.png')
    ...
    if ind==8:
       ...
       if ind==6:
            ...
            i=0
                ...
                picf=PhotoImage(file='imag/flow1.png')
